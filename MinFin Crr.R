...
## Enable Trust access to the VBA project object model
shell(shQuote(normalizePath("C:/Users/user/userov/Documents/Price/current/VBS1.vbs")), "cscript", flag = "//nologo")

getwd()
setwd("C:/Users/user.userovov/Documents/Price/current")
