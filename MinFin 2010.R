...
## Enable Trust access to the VBA project object model
shell(shQuote(normalizePath("C:/Users/user.userov/Documents/Price/2010/VBS1.vbs")), "cscript", flag = "//nologo")

getwd()
setwd("C:/Users/user.userov/Documents/Price/2010")
